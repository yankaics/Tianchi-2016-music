...
sql_play = 'select A.artist_id, A.ds as date, STDDEV(A.song_play) as play from (select Songs.artist_id , User_actions.ds, Songs.song_id, count(*) as song_play from User_actions left join Songs on Songs.song_id = User_actions.song_id where User_actions.action_type = 1 group by Songs.artist_id, User_actions.ds, Songs.song_id order by Songs.artist_id, Songs.song_id, User_actions.ds) as A group by A.artist_id, A.ds order by A.artist_id, A.ds;'
sql_download = 'select A.artist_id, A.ds as date, STDDEV(A.song_download) as download from (select Songs.artist_id , User_actions.ds, Songs.song_id, count(*) as song_download from User_actions left join Songs on Songs.song_id = User_actions.song_id where User_actions.action_type = 2 group by Songs.artist_id, User_actions.ds, Songs.song_id order by Songs.artist_id, Songs.song_id, User_actions.ds) as A group by A.artist_id, A.ds order by A.artist_id, A.ds;'

sql_collect = 'select A.artist_id, A.ds as date, STDDEV(A.song_collect) as collect from (select Songs.artist_id , User_actions.ds, Songs.song_id, count(*) as song_collect from User_actions left join Songs on Songs.song_id = User_actions.song_id where User_actions.action_type = 3 group by Songs.artist_id, User_actions.ds, Songs.song_id order by Songs.artist_id, Songs.song_id, User_actions.ds) as A group by A.artist_id, A.ds order by A.artist_id, A.ds;'
